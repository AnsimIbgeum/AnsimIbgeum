	    ...
	    <script>
			function advice_balloon() {
				$('#advice-balloonCheckbox').change(function() {
					if (this.checked) {
						$('.advice-balloon1_accountTransferfFail').show()
						console.log('말풍선을 표시합니다.')
					} else {
						$('.advice-balloon1_accountTransferfFail').hide()
					...
					<div class="row">
						<div id="service-content"> 
							<div style = "text-align : center;">
								<strong class = "transfer_fail_msg">${msg}</strong>
								<br><br>
							</div>
							<br><br>
							...
							<strong class="advice-balloon advice-balloon1_accountTransferfFail">해당 버튼을 이용해서 계좌 조회 및 이체 페이지로 이동이 가능합니다.</strong>
						</div>
					</div>
				</div>
