            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div id="service-content">
                        <!-- 여기에 넣으시며 됩니당 -->
                        <body>
                            <form action="/jgig/member_detail" method="get">
                            ...
                            <div class="find_btn d-flex">
                                <form action="member_update" class="mr-2" style="margin-right: 10px;">
                                    <button type="submit" class="button_tag">정보수정</button>
                                </form> 
                                <form action="member_delete">
                                    <button type="submit" class="button_tag">회원탈퇴</button>
                                </form>
                            </div>
