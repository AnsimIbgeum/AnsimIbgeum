        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                <div class="sidemenubox">
                    <h2 class="h3 pt-3 ">마이페이지</h2>
                    <hr>
                    <ul class="list-unstyled ">
                        <li><a
                            class="collapsed d-flex justify-content-between text-decoration-none "
                            href="/jgig/member_detail?mem_id=${sessionScope.mem_id}"> <!--선택된 메뉴는 selectsidemenu 클래스 추가 -->
                                내 정보
                        </a></li>
                        <li><a
                            class="collapsed d-flex justify-content-between text-decoration-none selectsidemenu"
                            href="/jgig/member_update"> 정보수정 </a></li>
                        <li><a
                            class="collapsed d-flex justify-content-between text-decoration-none "
                            href="/jgig/member_delete"> 회원탈퇴 </a></li>
                        <hr>
                    </ul>
                </div>
            </div>
                            ...
                            <form action="/jgig/member_update" method="post">
                                <p>
                                    이름(실명)<br> <input type="text" name="mem_nm"
                                        value="${memberDto.mem_nm}"class="underlined-input"  />
                                </p>
                                <p>
                                    아이디<br> <input type="text" name="mem_id"
                                        value="${memberDto.mem_id}" class="underlined-input" readonly />
                                </p>
                                <p>
                                    닉네임<br> <input type="text" name="nickname"
                                        value="${memberDto.nickname}" class="underlined-input" />
                                </p>
                                <p>
                                    전화번호<br> <input type="text" name="phone_num"
                                        value="${memberDto.phone_num}"class="underlined-input"  />
                                </p>
                                
                                <p>
                                    비밀번호<br> <input type="text" name="mem_pw"
                                        value="${memberDto.mem_pw}"class="underlined-input"  />
                                </p>
                                <br> <input type="hidden" name="mem_id"
                                    value="${memberDto.mem_id}">
                                <button type="submit"class="button_tag">변경하기</button>
                            </form>
                        </body>
                    </div>
                </div>
