						...
						<div id="content">
							...
							<script>
							  function goToNoticeDetail(noticeId) {
							    ...
							    var noticeDetailUrl = 'board_detail?no=' + noticeId;
								...
								<ul class="pagination">
									<c:if test="${criteria.prev}">
										<li class="page-item"><a class="page-link"
											href="board_my_list_action?searchTag=${criteria.searchTag}&keyword=${criteria.keyword }&pageNum=${criteria.pageNum-1 }">이전</a></li>
									</c:if>
									<c:forEach begin="${criteria.beginPage}" end="${criteria.endPage}" var="idx">
									  ...
									  <li class="page-item ${isCurrentPage ? 'active' : ''}">
									    <a class="page-link" href="board_my_list_action?searchTag=${criteria.searchTag}&keyword=${criteria.keyword }&pageNum=${idx}">
									      ${idx}
									    </a>
									  </li>
									</c:forEach>
									<c:if test="${criteria.next}">
										<li class="page-item"><a class="page-link"
											href="board_my_list_action?searchTag=${criteria.searchTag}&keyword=${criteria.keyword }&pageNum=${criteria.pageNum+1 }">다음</a></li>
									</c:if>
								</ul>
							</nav>

							<form action="board_search_action" method="get"
								class="nav justify-content-center">
								<fieldset>
									<table>
							...
							<a href="/jgig/board_insert_form"><button
									class="btn btn-outline-warning" style="float: right;">게시물 등록</button></a> <a
								href="board_list"><button class="btn btn-outline-warning">게시판
									목록</button></a> <br>
