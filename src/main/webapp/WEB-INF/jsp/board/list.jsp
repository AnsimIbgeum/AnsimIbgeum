				...
				<div class="row">
					<div id="service-content">
						...
						<div id="content">
								...
								<ul class="pagination">
									<c:if test="${criteria.prev}">
										<li class="page-item"><a class="page-link"
											href="board_list?pageNum=${criteria.pageNum-1 }">이전</a></li>
									</c:if>
									<c:forEach begin="${criteria.beginPage}" end="${criteria.endPage}" var="idx">
									  ...
									  <li class="page-item ${isCurrentPage ? 'active' : ''}">
									    <a class="page-link" href="board_list?pageNum=${idx}">
									      ${idx}
									    </a>
									  </li>
									</c:forEach>
									<c:if test="${criteria.next}">
										<li class="page-item"><a class="page-link"
											href="board_list?pageNum=${criteria.pageNum+1 }">다음</a></li>
									</c:if>
								</ul>
							</nav>
							...
							<a href="/jgig/board_insert_form">
								<button class="btn btn-outline-warning" style="float: right;">게시물
									등록</button>
							</a>
