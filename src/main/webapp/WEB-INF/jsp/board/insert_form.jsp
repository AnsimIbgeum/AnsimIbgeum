						...
						<form action="board_insert_action" method="post">
							<fieldset>
								<input type="hidden" name="mem_id"
									value="${sessionScope.mem_id}"> 제목 : <input type="text"
									name="title" class="form-control"> <br> 카테고리 : 자유<input
									type="radio" name="brd_category" value='자유' checked
									class="form-check-input"> 질문<input type="radio"
									name="brd_category" value='질문' class="form-check-input">
								<br> 작성자 : ${sessionScope.mem_id} <br> 내 용 : <br>
								<textarea rows="10" cols="125" name="brd_content"
									class="form-control"></textarea>
								<br> <a href="/jgig/board_insert_form"><button
										class="btn btn-outline-warning" style="float: right;">게시물 등록</button></a><br>
								<br>
							</fieldset>
						</form>
						<hr>
