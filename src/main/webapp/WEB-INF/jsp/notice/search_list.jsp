						...
						<div id="content">
							<table class="table table-hover">
								...
								<tr>
									...
									<th>작성일</th>
									<th>조회수</th>
									<c:forEach items="${search_list}" var="ntc">
								...
								<ul class="pagination">
									<c:if test="${criteria.prev}">
										<li class="page-item"><a class="page-link"
											href="notice_search_action?searchTag=${criteria.searchTag}&keyword=${criteria.keyword }&pageNum=${criteria.pageNum-1 }">이전</a></li>
									</c:if>
									<c:forEach begin="${criteria.beginPage}"
										end="${criteria.endPage}" var="idx">
										<li class="page-item"><a class="page-link"
											href="notice_search_action?searchTag=${criteria.searchTag}&keyword=${criteria.keyword }&pageNum=${idx}">
												${idx} </a></li>
									</c:forEach>
									<c:if test="${criteria.next}">
										<li class="page-item"><a class="page-link"
											href="notice_search_action?searchTag=${criteria.searchTag}&keyword=${criteria.keyword }&pageNum=${criteria.pageNum+1 }">다음</a></li>
									</c:if>
								</ul>
							</nav>

							<form action="notice_search_action" method="get"
								class="nav justify-content-center" class="btn btn-warning">
								<fieldset>
									<table>
							...
							<a href="notice_list"><button class="btn btn-success">공지사항
									목록</button></a> <br>
